...
FindExactWordsUntilTheContentIsTooSmallOrEndOfRecordAsm PROC
...
CompareWordsUntilTheContentIsTooSmallOrEndOfRecord:
        ...
        je VeryInnerLoop; descriptionArray[IndexToCharInContentArray].DlugoscSlowa == dlugoscWyrazeniaItem
        jl WyrazenieItemShorterThanSearchTerm
        jg WyrazenieItemLongerThanSearchTerm
 
WyrazenieItemShorterThanSearchTerm:
...
WyrazenieItemLongerThanSearchTerm:
    add esi, eax
...
FindExactWordsUntilTheContentIsTooSmallOrEndOfRecordAsm ENDP
