...
extern "C" {
    ...
    shookayEngine_API void FindExactUTF8WithCallback(shookayEngine* searchEngine, const char* wyrazenie,  ProgressCallback progressCallback);
    shookayEngine_API int* FindExactUTF16(shookayEngine* searchEngine, const char16_t* wyrazenie, int* length);
    shookayEngine_API void FindExactUTF16WithCallback(shookayEngine* searchEngine, const char16_t* wyrazenie,  ProgressCallback progressCallback);
    shookayEngine_API int* FindExactUTF32(shookayEngine* searchEngine, const char32_t* wyrazenie, int* length);
    shookayEngine_API void FindExactUTF32WithCallback(shookayEngine* searchEngine, const char32_t* wyrazenie,  ProgressCallback progressCallback);
